...
const localPhotos = [
  { src: safariLandscape1, alt: "Safari Landscape 1", iso: "100", aperture: "f/11", shutter: "1/250", camera: "Leica Q2", lens: "28mm f/1.7", location: "Masai Mara, Kenya" },
  { src: safariLandscape2, alt: "Safari Landscape 2", iso: "200", aperture: "f/8", shutter: "1/500", camera: "Leica Q2", lens: "28mm f/1.7", location: "Masai Mara, Kenya" },
  { src: safariPhoto3, alt: "Safari Photo 3", iso: "400", aperture: "f/5.6", shutter: "1/1000", camera: "Leica Q2", lens: "28mm f/1.7", location: "Masai Mara, Kenya" },
  { src: safariPhoto4, alt: "Safari Photo 4", iso: "320", aperture: "f/4", shutter: "1/800", camera: "Leica Q2", lens: "28mm f/1.7", location: "Masai Mara, Kenya" },
];
...
type PhotoType = typeof allPhotos[0];
...
export function SafariGallery({ view, lightbox, setLightbox, onViewChange }: GalleryProps) {
  ...
  return (
    <section className="h-screen bg-background overflow-hidden">
      ...
      >
        ...
        {/* End card */}
        <div className="flex-shrink-0 h-full flex items-center justify-center w-48">
          <img
            src={safariBaggageTag}
            alt="Baggage Tag"
            className="h-48 object-contain opacity-50 rotate-90"
          />
        </div>
