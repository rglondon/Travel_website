...
export const AdminDashboard: React.FC = () => {
  ...
  const loadGalleries = useCallback(async () => {
    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        setGalleries(data.map((g: { id: string; title: string; description?: string; cover_image_url?: string; is_published: boolean; is_active: boolean; visibility_settings?: { is_public?: boolean; show_on_homepage?: boolean }; created_at: string; updated_at: string }) => ({
          ...g,
          name: g.title,
          ...
          visibilitySettings: g.visibility_settings || { isPublic: true, showOnHomepage: false, homepageOrder: 0 },
          seoSettings: {},
  ...
  const handleCreateGallery = async () => {
    const newGallery = {
      ...
      seo_settings: {},
      display_settings: { layout: 'grid', photoPerPage: 20, showLocation: true, showDate: true, showPhotographer: true, enableLightbox: true, enableDownload: false },
