...
-- Add missing columns for AI integration
ALTER TABLE photos ADD COLUMN IF NOT EXISTS ai_processed BOOLEAN DEFAULT FALSE;
ALTER TABLE photos ADD COLUMN IF NOT EXISTS ai_model TEXT;
ALTER TABLE photos ADD COLUMN IF NOT EXISTS ai_processed_at TIMESTAMPTZ;
...
AND column_name IN ('ai_processed', 'ai_model', 'ai_processed_at');
